      ...
      <div className={styles.container}>
        ...
        <div className={styles.about}>
          <h1 className={styles.title}>
            Early US voting numbers indicate record turnout for November
            election
          </h1>
          ...
          <div className={styles.column}>
            ...
            <div className={styles.articleContainer}>
              ...
              <p className={styles.paragraph}>
                ...
                coronavirus pandemic and an eagerness to weigh in on the
                political future of Trump, said Michael McDonald of the
                University of Florida, who administers the project.
              </p>
              ...
              <p className={styles.paragraph}>
                ...
                about 150 million, representing 65 percent of eligible voters,
                the highest rate since 1908.
              </p>
              <p className={styles.paragraph}>
              ...
              <p className={styles.paragraph}>
                ...
                and will grow rapidly as more states begin early in-person
                voting and report absentee mail-in totals in the next few weeks.
                All but about a half-dozen states allow some level of early
                in-person voting.
              </p>
              <p className={styles.paragraph}>
                The percentage of voters who cast their ballot at a voting
                machine on Election Day already had been in steady decline
                before this year, according to the US Election Assistance
                Commission.
              </p>
              <p className={styles.paragraph}>
                The total number of early or mail-in votes more than doubled
                from nearly 25 million in 2004 to 57 million in 2016, it said,
              ...
              <p className={styles.paragraph}>
                ...
                unfounded accusations that it leads to fraud. Experts say fraud
                is rare.
              </p>
              <p className={styles.paragraph}>
              ...
              <p className={styles.paragraph}>
                ...
                before surging just ahead of the election. But in some states,
                the rates of participation already have skyrocketed a month out.
              </p>
              <p className={styles.paragraph}>
                In South Dakota, early voting is nearly 23 percent of the total
                turnout in 2016. It is nearly 17 percent of total 2016 turnout
                in Virginia and nearly 15 percent of total 2016 turnout in the
